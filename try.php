...
if(isset($_POST['update_status'])) {
    ...
    $stmt = $conn->prepare("UPDATE volunteer_tasks SET status=? WHERE id=? AND volunteer_id=?");
...
// Fetch announcements
$announcements = $conn->query("SELECT * FROM announcements ORDER BY event_date ASC");
?>
